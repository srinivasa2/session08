var module = angular.module('demoApp', ['ngMockE2E', 'ngRoute', 'ngAnimate'])
...
module.controller('ReportCtrl', ['$scope', '$http', 'reportdata', 'UserData', function($scope, $http, reportdata, UserData) {
